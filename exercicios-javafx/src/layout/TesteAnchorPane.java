...
public class TesteAnchorPane extends AnchorPane {
	...
	public TesteAnchorPane() {
		...
		//Adicionar quadrado q5 na caixa central para que ele acompanhe a tela
		Quadrado q5 = new Quadrado();
		centro.getChildren().add(q5);
		
		//Adicionar quadrados na cena
		this.getChildren().addAll(q1, q2, q3, q4, centro);
	}
}
